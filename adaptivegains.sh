...
OLDESTBOOT="$(($(sudo journalctl --list-boots | wc -l)-1))"  # Numeric value of oldest boot.  (Only relevant if 'Storage=persistent' is set in the '/etc/systemd/journald.conf' file.)
LINECOUNT=0
